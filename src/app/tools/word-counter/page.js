        ...
        <div className="mx-3 md:mx-10 lg:mx-18">
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
              ...
              <li aria-hidden="true" className="text-gray-300">/</li>
              <li aria-current="page" className="font-semibold text-[#3A9D44]">Word Counter</li>
            </ol>
          </nav>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-6">
              <FaFileAlt className="mr-3 text-3xl text-[#4DB154]" />
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex space-x-2">
                  <label className="flex cursor-pointer items-center text-sm text-[#3A9D44] hover:text-[#4DB154]">
              ...
              <textarea
                ...
                className="h-64 w-full resize-none rounded-lg border border-gray-300 p-3 outline-none focus:border-[#4DB154] focus:ring-2 focus:ring-[#4DB154]/20"
              />
            ...
            {text && (
              <div className="mt-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                  <div className="rounded-lg bg-[#4DB154]/10 p-4 text-center">
                    <div className="text-2xl font-bold text-[#3A9D44]">{stats.wordCount}</div>
                    <div className="text-sm text-[#3A9D44]">Words</div>
                  </div>
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-md bg-[#3A9D44] px-5 py-2 font-medium text-white transition-colors hover:bg-[#4DB154]"
                  >
                    <FaDownload size={14} />
                    Download Results
                  </button>
          ...
          <div className="mt-5 rounded-xl bg-gradient-to-r from-[#3A9D44] to-[#4DB154] p-8 text-center text-white">
            ...
            <a 
              href="/contact" 
              className="inline-block rounded-md bg-white px-6 py-3 font-medium text-[#3A9D44] transition-colors hover:bg-gray-100"
            >
              Get in Touch
            </a>
          </div>
