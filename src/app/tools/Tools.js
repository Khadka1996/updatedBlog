...
const tools = [
  { icon: <MdMergeType className="text-brand-green text-4xl" />, title: "Merge PDF", description: "Combine PDFs in the order you want with the easiest PDF merger available." },
  { icon: <FaFilePdf className="text-brand-green text-4xl" />, title: "Split PDF", description: "Separate one page or a whole set for easy conversion into independent PDF files." },
  { icon: <FaFileAlt className="text-brand-green text-4xl" />, title: "Compress PDF", description: "Reduce file size while optimizing for maximal PDF quality." },
  ...
  { icon: <FaImage  className="text-brand-green text-4xl" />, title: "Photo to PDF", description: "Crop your images with precision to highlight the perfect area." },
