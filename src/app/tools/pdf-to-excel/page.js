...
import { FaFilePdf, FaFileExcel, FaDownload, FaExchangeAlt, FaInfoCircle, FaTable, FaArrowRight } from 'react-icons/fa';
...
export default function PdfToExcel() {
  ...
  return (
    ...
    <div className="p-6 bg-gray-100 ">
      <Head>
        <title>PDF to Excel Converter - PDF Tools</title>
        <meta name="description" content="Extract tables and data from PDF files to Excel spreadsheets" />
      ...
      <div className="mx-3 md:mx-10 lg:mx-18">
        ...
        <div className="flex items-center mb-6">
          <ToolBreadcrumbs label="PDF to Excel" />
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            <div className="flex items-center">
              ...
              <FaFileExcel className="text-green-500 text-3xl ml-2" />
            </div>
            <h1 className="text-3xl font-bold text-gray-900 ml-4">PDF to Excel</h1>
          </div>
          
          <p className="text-gray-600 mb-8">
            Extract tables and data from your PDF files and convert them to editable Excel spreadsheets.
          </p>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <label className="flex items-center">
                        <input
                          type="radio"
                          checked={conversionOptions.outputFormat === 'xlsx'}
                          onChange={() => handleOptionChange('outputFormat', 'xlsx')}
                          className="mr-2"
                        />
                      ...
                      <label className="flex items-center">
                        <input
                          type="radio"
                          checked={conversionOptions.outputFormat === 'xls'}
                          onChange={() => handleOptionChange('outputFormat', 'xls')}
                          className="mr-2"
                        />
                        <span>XLS (Older Excel)</span>
                      </label>
                    </div>
                  </div>
                  
                  <div>
                    <label className="block mb-2 font-medium">Table Detection</label>
                    <select
                      value={conversionOptions.tableDetection}
                      onChange={(e) => handleOptionChange('tableDetection', e.target.value)}
                      className="w-full p-2 border border-gray-300 rounded"
                    >
                      <option value="auto">Automatic (Recommended)</option>
                      <option value="manual">Manual Selection</option>
                      <option value="all-text">Convert All Text</option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span>Include images in output</span>
                    </label>
                  </div>
          ...
          {downloadUrl && (
            <div className="mt-6 text-center">
              <a 
                href={downloadUrl} 
                download={`${file.name.replace('.pdf', '')}.${conversionOptions.outputFormat}`}
          ...
          {!file && (
            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-600">
                <li>Perfect for financial reports, invoices, and data tables</li>
                <li>Preserves numerical data and formatting</li>
                <li>Converts tables to editable Excel sheets</li>
                <li>Maintains row and column structure</li>
                <li>For best results, use PDFs with clear table structures</li>
              </ul>
              
              <div className="mt-4 p-3 bg-white rounded border border-gray-200">
                <h4 className="font-medium flex items-center">
                  <FaTable className="mr-2 text-green-500" />
                  Example PDFs that convert well:
                </h4>
                <ul className="list-disc pl-5 text-sm text-gray-600 mt-2">
                  <li>Financial statements</li>
                  <li>Product catalogs</li>
                  <li>Research data tables</li>
