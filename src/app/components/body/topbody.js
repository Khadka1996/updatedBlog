    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row items-center justify-center text-center p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-0 lg:space-x-12">
        ...
        <div className="mx-2 sm:mx-6 md:mx-10 lg:mx-18">
          ...
          <a
            href="/contact"
            className="group bg-[#4caf4f] text-white py-3 px-7 rounded-lg mt-4 sm:mt-6 inline-flex items-center justify-center space-x-2 text-base sm:text-lg hover:bg-[#6a9b52] transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#4caf4f] focus:ring-offset-2"
          >
